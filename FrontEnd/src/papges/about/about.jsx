    ...
    <div className="about">
      <div className="about-container">
        <div className="about-hero">
          <h1 className="about-title">Welcome to Chanu@Music</h1>
          ...
          <div className="about-section about-section-highlight">
            ...
            <div className="about-features">
              <div className="about-feature">
                <h3 className="about-feature-title">Curated Selection</h3>
                <p className="about-feature-text">Our team of music enthusiasts meticulously curates each instrument, bringing you a diverse range of options to suit your style and preferences.</p>
              </div>
              <div className="about-feature">
                <h3 className="about-feature-title">Quality Assurance</h3>
                <p className="about-feature-text">We stand by the quality of every instrument we offer. You can trust that your purchase is an investment in both sound and durability.</p>
              </div>
              <div className="about-feature">
                <h3 className="about-feature-title">Community Hub</h3>
                <p className="about-feature-text">Chanu@Music is not just a place to buy instruments; it's a hub for musicians to connect, share experiences, and learn from each other.</p>
              </div>
              <div className="about-feature">
                <h3 className="about-feature-title">Seller Platform</h3>
                <p className="about-feature-text">Musicians who create their own harmonies can become sellers here, sharing their unique creations with a global audience.</p>
              </div>
              <div className="about-feature">
                <h3 className="about-feature-title">Expert Support</h3>
                <p className="about-feature-text">Our dedicated support team is here to assist you at every step of your musical journey – from choosing the right instrument to post-purchase guidance.</p>
              </div>
            </div>
          </div>

          <div className="about-cta">
            <h2 className="about-cta-title">Join Our Melodic Journey</h2>
            ...
            <p className="about-music-note">🎵 Let the music play! 🎵</p>
          </div>
        </div>
      </div>
    </div>
